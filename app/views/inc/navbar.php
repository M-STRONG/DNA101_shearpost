<nav class="navbar navbar-expand-lg navbar-dark bg-dark ">
  <div class="container-fluid">
    <a class="navbar-brand" href="<?php echo URLROOT; ?>/pages/home">DNA101</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" aria-current="page" href="<?php echo URLROOT; ?>">Posts</a>
        </li>
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0 d-flex">
        ...
        <script>
          document.addEventListener('DOMContentLoaded', function() {
            var postLink = document.querySelector('.navbar-nav > .nav-item:nth-child(2) > .nav-link');
